...
that sits on the ground under the cursor. Terrain between a vertex and the sun or the
lamp darkens that vertex, so cliffs cast shadows. With textures on, each top samples that cell's
